...
import type { GatewayPresenceUpdate } from 'discord-player/node_modules/discord-api-types/payloads/v10/gateway';
import type { APIApplication, APIChannel, APIEmoji, APIGuild, APIGuildIntegration, APIGuildMember, APIGuildScheduledEvent, APIInteraction, APIMessage, APIRole, APIStageInstance, APISticker, APIThreadChannel, APIThreadMember, APIUnavailableGuild, APIUser, GatewayActivity, GatewayPresenceUpdate as RawGatewayPresenceUpdate, GatewayThreadListSync as RawGatewayThreadListSync, GatewayThreadMembersUpdate as RawGatewayThreadMembersUpdate, GatewayVoiceState, InviteTargetType, PresenceUpdateStatus } from 'discord-player/node_modules/discord-api-types/payloads/v10';
import type { Nullable } from 'discord-player/node_modules/discord-api-types/utils/internals';
export * from 'discord-player/node_modules/discord-api-types/gateway/common';
