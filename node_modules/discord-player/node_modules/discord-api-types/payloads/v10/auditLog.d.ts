 ...
 */
import type { APIChannel, APIOverwrite } from 'discord-player/node_modules/discord-api-types/payloads/v10/channel';
import type { APIGuildIntegration, GuildDefaultMessageNotifications, GuildExplicitContentFilter, GuildMFALevel, GuildVerificationLevel, IntegrationExpireBehavior } from 'discord-player/node_modules/discord-api-types/payloads/v10/guild';
import type { APIGuildScheduledEvent, GuildScheduledEventEntityType, GuildScheduledEventStatus } from 'discord-player/node_modules/discord-api-types/payloads/v10/guildScheduledEvent';
import type { APIApplicationCommand } from 'discord-player/node_modules/discord-api-types/payloads/v10/interactions';
import type { APIRole } from 'discord-player/node_modules/discord-api-types/payloads/v10/permissions';
import type { StageInstancePrivacyLevel } from 'discord-player/node_modules/discord-api-types/payloads/v10/stageInstance';
import type { StickerFormatType } from 'discord-player/node_modules/discord-api-types/payloads/v10/sticker';
import type { APIUser } from 'discord-player/node_modules/discord-api-types/payloads/v10/user';
import type { APIWebhook } from 'discord-player/node_modules/discord-api-types/payloads/v10/webhook';
